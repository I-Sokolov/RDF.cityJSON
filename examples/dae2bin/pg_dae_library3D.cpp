			...
			)
{
	...
	double	size = Vec3Normalize((VE__CTOR*) pOut);
	if	(size == 0) {
...
{
	int64_t	owlClassMatrix = GetClassByName(rdfModel, "Matrix"),
	...
	int64_t	instanceMatrix = CreateInstance(owlClassMatrix, nullptr);
