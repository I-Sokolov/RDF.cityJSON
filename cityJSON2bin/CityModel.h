...
public:
    ...
    RdfProperty GetOrCreateProperty(OwlClass cls, const char* propName, RdfPropertyType propType, const char* refCls = nullptr, int64_t minCard = 0, int64_t maxCard = 1, int attempt = 0);
